...
public class ScriptEvents {
    ...
    public void onKeyTyped(KeyPressEvent e) {
        ...
        String keyName = Keyboard.getKeyName(e.keyCode);
        boolean state = true;
        boolean inGui = Minecraft.getMinecraft().currentScreen != null;
        if (Raven.scriptManager.invokeBoolean("onKey", module, keyName, e.keyCode, state, inGui) == 0) {
            e.setCanceled(true);
        }
    }
    ...
    public void onKeyInput(InputEvent.KeyInputEvent e) {
        ...
        boolean inGui = Minecraft.getMinecraft().currentScreen != null;
        Raven.scriptManager.invokeBoolean("onKey", module, keyName, keyCode, state, inGui);
    }
    ...
    public void onMouse(MouseEvent e) {
        if (Raven.scriptManager.invokeBoolean("onMouse", module, e.button, e.buttonstate, Mouse.getX(), Mouse.getY()) == 0) {
            e.setCanceled(true);
        }
    }

...
import keystrokesmod.module.impl.client.StartupAnim;
...
public class ModuleManager {
    ...
    public static ModernArrayList modernArrayList;
    public static PotionHUD potionHUD;
    public static Timer timer;
    public static Fly fly;
    public static WTap wTap;
    public static Velocity velocity;
    public static ExpoAutoBlock expoAutoBlock;
    ...
    public static Telly telly;
    public static GhettoScaffold ghettoScaffold;
    public static Breezily breezily;
    public static LegitScaffoldRotV19 legitScaffoldRotV19;
    public static Scaffold scaffold;
    public static Atrueadamscaffold atrueadamscaffold;
    public static TellyBridge tellyBridge;
    public static SpeedTelly speedTelly;
    ...
    public static CuteVisuals cuteVisuals;
    public static ClientTheme clientTheme;
    public static StartupAnim startupAnim;
    ...
    public void register() {
        ...
        this.addModule(startupAnim = new StartupAnim());
        ...
        this.addModule(expoAutoBlock = new ExpoAutoBlock());
        ...
        this.addModule(telly = new Telly());
        this.addModule(ghettoScaffold = new GhettoScaffold());
        this.addModule(breezily = new Breezily());
        this.addModule(legitScaffoldRotV19 = new LegitScaffoldRotV19());
        this.addModule(scaffold = new Scaffold());
        this.addModule(atrueadamscaffold = new Atrueadamscaffold());
        ...
        this.addModule(modernArrayList = new ModernArrayList());
        ...
        this.addModule(notification = new Notification());
        this.addModule(killEffect = new KillEffect());
        this.addModule(moduleList = new ModuleList());
        this.addModule(waterMark = new WaterMark());
        this.addModule(dynamicIsland = new DynamicIsland());
        this.addModule(cuteVisuals = new CuteVisuals());

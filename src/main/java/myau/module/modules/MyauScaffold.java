...
public class MyauScaffold extends Module {
    ...
    public final ModeProperty rotationMode = new ModeProperty("rotations", 4, new String[]{"NONE", "DEFAULT", "BACKWARDS", "SIDEWAYS", "GODBIRGDE", "SMOOTH", "Hypixel", "SNAP", "3FMC", "SNAP2"});
    ...
    public final ModeProperty moveFix = new ModeProperty("move-fix", 0, new String[]{"NONE", "SILENT"});
